...
fixpoint. This is what lets Tempo reason about intervals that are
\emph{not} grounded: a period known only as ``before or after the
rebuild, never during'' is the set
